...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://46sekle1gj.execute-api.us-east-2.amazonaws.com/firstStage';
    ...
    apigClient.searchGet = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['mood'], ['body']);
        ...
        var searchGetRequest = {
            ...
            queryParams: apiGateway.core.utils.parseParametersToObject(params, ['mood']),
            body: body
        };
